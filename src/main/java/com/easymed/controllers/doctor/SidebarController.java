...
public class SidebarController implements Initializable {
    ...
    public void patients(ActionEvent actionEvent) {
        Helpers.toggleMenuClass(actionEvent);
        FXMLScene.switchScene("/com/easymed/views/doctor/patients-list.fxml", (Node) actionEvent.getSource());
    }
    ...
    public void doctors(ActionEvent actionEvent) {
        Helpers.toggleMenuClass(actionEvent);
        FXMLScene.switchScene("/com/easymed/views/doctor/doctors-list.fxml", (Node) actionEvent.getSource());
    }
    ...
    public void profile(ActionEvent actionEvent) {
        Helpers.toggleMenuClass(actionEvent);
        FXMLScene.switchScene("/com/easymed/views/doctor/profile.fxml", (Node) actionEvent.getSource());
    }
